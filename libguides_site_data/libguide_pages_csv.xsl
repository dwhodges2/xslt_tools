...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="heads">id|name|guide_id|url|source_page_id|parent_page_id|position|hidden|redirect|created|updated|modified|editors|box_count</xsl:variable>
